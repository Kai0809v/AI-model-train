...
for i, seed in enumerate([42, 123, 456, 789, 2024]):
    model_i, losses_i = train_single_model(seed)
    ensemble_models.append(model_i)
    if i == 0:
        all_train_losses = losses_i
...
plt.plot(range(1, len(all_train_losses) + 1), all_train_losses, marker='o', linestyle='-', color='b', label='Train')
